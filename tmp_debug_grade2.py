...
with app.app_context():
    ...
    def build_subject(subject, final_score):
        ...
        for cat, score in zip(categories, scores):
            Assessment(student_id=s.id, category=cat, subject=subject, score=score, max_score=100, teacher_id=1)
        Assessment(student_id=s.id, category='end_term', subject=subject, score=final_score, max_score=100, teacher_id=1)

    for subject, final in [
        ('English Language',72),('Mathematics',68),('Integrated Science',60),('Social Studies',72),
        ('Elective 1',80),('Elective 2',72),('Elective 3',68),('Elective 4',68)]:
