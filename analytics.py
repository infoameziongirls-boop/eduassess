...
def get_grade_distribution(subject=None, class_name=None, teacher_id=None):
    ...
    distribution = {'A1': 0, 'B2': 0, 'B3': 0, 'C4': 0, 
    ...
    for student in students:
        ...
        if final is None:
            continue
        if final >= 80: distribution['A1'] += 1
        elif final >= 70: distribution['B2'] += 1
        elif final >= 65: distribution['B3'] += 1
        elif final >= 60: distribution['C4'] += 1
        elif final >= 55: distribution['C5'] += 1
        elif final >= 50: distribution['C6'] += 1
        elif final >= 45: distribution['D7'] += 1
        elif final >= 40: distribution['E8'] += 1
        else: distribution['F9'] += 1
